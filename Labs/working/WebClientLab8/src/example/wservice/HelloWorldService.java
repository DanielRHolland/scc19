 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://HelloMavenGlassfish/", wsdlLocation = "http://localhost:9000/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://HelloMavenGlassfish/", "HelloWorldService");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://HelloMavenGlassfish/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://HelloMavenGlassfish/", "HelloWorldPort"), HelloWorld.class, features);
    }
