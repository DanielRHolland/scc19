 ...
 * generated in the example.wservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorldFrom_QNAME = new QName("http://HelloMavenGlassfish/", "sayHelloWorldFrom");
    private final static QName _SayHelloWorldFromResponse_QNAME = new QName("http://HelloMavenGlassfish/", "sayHelloWorldFromResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: example.wservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://HelloMavenGlassfish/", name = "sayHelloWorldFrom")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://HelloMavenGlassfish/", name = "sayHelloWorldFromResponse")
